  ...
  return (
    <html lang="zh-CN">
      <body className="bg-custom-background lg:px-8">
        <header className="relative z-10 w-full flex-none text-sm font-semibold leading-6 text-slate-900">
          <nav aria-label="Global" className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative flex items-center py-[2.125rem]">
              <Link className="flex gap-x-3 text-slate-900" href="/">
                <Image src="/favicon.ico" alt="Wondervoy" width={24} height={24} />
                <div className="text-lg text-slate-900">wondervoy</div>
              </Link>
              <Link
